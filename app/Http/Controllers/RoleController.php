...
class RoleController extends Controller
{
    ...
    public function index()
    {
            ...
            $roles = Role::all();
            return view('backend.partial.roles.index', compact('roles'));
    ...
    {
        return view('backend.partial.roles.create');
    }
    ...
    {
        $role = Role::find($id);
        return view('backend.partial.roles.show', compact('role'));
    }
    ...
    {
        $role = Role::find($id);
        return view('backend.partial.roles.edit', compact('role'));
    }
    ...
    public function showPermissions($id){
        ...
        return view('backend.partial.roles.assign',compact('permissions','role'));
    }
